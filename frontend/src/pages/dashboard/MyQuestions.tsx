...
import myContent from "../../illustrations/my-content.svg";
			...
			<div style={ { display: "flex", gap: "var(--spacing)" } }>
				<div style={ { flex: 1 } }>
					<h1>
						...
						{ t('dashboard.myQuestions.title') }
					</h1>
					<p>{ t('dashboard.myQuestions.caption') }</p>
				...
				<img src={ myContent } alt={ "My Questions" }
					 style={ { height: "120px", alignSelf: "center", userSelect: "none", pointerEvents: "none" } }/>
			</div>
		</Section>
	}
	
	return <QuestionList url={ "question/my" } header={ header }/>
}
